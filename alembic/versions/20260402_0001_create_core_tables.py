...
def upgrade() -> None:
    ...
    op.create_index(op.f("ix_source_documents_batch_id"), "source_documents", ["batch_id"], unique=False)
    ...
    op.create_index(op.f("ix_source_documents_processed"), "source_documents", ["processed"], unique=False)
    ...
    op.create_table(
        ...
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
        sa.ForeignKeyConstraint(["document_id"], ["source_documents.id"], name=op.f("fk_red_flags_document_id_source_documents")),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_red_flags")),
    )
    op.create_index(op.f("ix_red_flags_id"), "red_flags", ["id"], unique=False)
    op.create_index(op.f("ix_red_flags_document_id"), "red_flags", ["document_id"], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f("ix_red_flags_document_id"), table_name="red_flags")
    op.drop_index(op.f("ix_red_flags_id"), table_name="red_flags")
    op.drop_table("red_flags")

    op.drop_index(op.f("ix_source_documents_processed"), table_name="source_documents")
    ...
    op.drop_index(op.f("ix_source_documents_batch_id"), table_name="source_documents")
